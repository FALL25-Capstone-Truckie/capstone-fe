...
const AdminOrderList: React.FC = () => {
    ...
    const getColumns = () => {
        ...
        // Thêm cột thao tác (chỉ có nút xem chi tiết)
        const actionColumn = {
            title: 'Thao tác',
            key: 'action',
            width: 100,
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <Title level={2} className="flex items-center m-0 text-blue-800">
                            <ShoppingCartOutlined className="mr-3 text-blue-600" /> Đơn hàng
                        </Title>
                        <Text type="secondary">Xem thông tin và trạng thái của các đơn hàng trong hệ thống</Text>
                    </div>
                    <Button
                        type="primary"
