...
const RouteMapSection: React.FC<RouteMapSectionProps> = ({ journeySegments, vehicleInfo }) => {
                ...
                try {
                    ...
                    if (segment.startLatitude && segment.startLongitude) {
                        newMarkers.push({
                            ...
                            type: segment.startPointName?.toLowerCase().includes('pickup') ? 'pickup' :
                                segment.startPointName?.toLowerCase().includes('carrier') ? 'carrier' : 'stopover',
                        });
                    }
        ...
        return (
            <Card className="mb-6 shadow-md rounded-xl">
                <Title level={5} className="mb-4 flex items-center">
                    ...
                    Lộ trình vận chuyển {vehicleInfo?.licensePlateNumber ? `- ${vehicleInfo.licensePlateNumber}` : ''}
                </Title>
